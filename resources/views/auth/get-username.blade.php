...
<body>
    ...
    <h3 class="text-center mb-4" style="font-weight: bold; color: #333;">Your Username</h3>

    <!-- Email Address (non-selectable text) -->
    ...
    <!-- Username (non-selectable text) -->
    <div class="form-group">
        <label for="username">Username</label>
        <p id="username" class="form-control-plaintext"  >
            {{ $username }}
        </p>
    </div>
    ...
    <!-- Submit Button -->
    <button type="button" class="btn btn-primary mt-3" onclick="window.location='{{ route('login') }}'">Close</button>
