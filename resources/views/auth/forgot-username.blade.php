    ...
    <main id="main">
        ...
        <div class="breadcrumbs d-flex align-items-center"
            ...
            <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
                ...
                <div class="reply-form bg-sp shadow-lg rounded p-4" style="width: 35%; max-width: 450px;font-size: 16px;">
                    <h3 class="text-center mb-4" style="font-weight: bold; color: #333;font-size: 26px;">Forgot Username?</h3>
                    <p class="text-center" style="color: #555;">
                        No problem. Enter your email address below, and get Username.
                    </p>
                    <form method="POST" action="{{ route('username.reset') }}" class="mt-3">
                        @csrf
