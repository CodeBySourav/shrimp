    ...
    <section id="dashboard-content" class="dashboard-content">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
                ...
                <p>Here you can manage your profile, view your sales, and manage your products.</p>
...
<!-- AJAX Script for Vendor-Specific Data -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<script type="text/javascript">
$(document).ready(function() {
    // Load products for the logged-in vendor on page load
    $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        Highcharts.chart('container', {
                            ...
                            series: [{ name: 'Quantity', data: response.quantity_ranges.map(() => 1) }]
                        });
                    }
                },
                error: function(xhr) {
